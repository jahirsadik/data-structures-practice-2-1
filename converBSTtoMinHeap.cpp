...
sorted order. ~ Now perform the preorder traversal of the tree.
~ While traversing the root during the preorder traversal, one by one copy
the values from the array arr[] to the nodes.
        *** notice the use of pointer to i in inorderTraversal().
*/
